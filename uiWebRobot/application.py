...
class UIWebRobot:
    ...
    def on_socket_data(self, data):
        ...
        msg_socket_data_after_event = ["run_move_to_target", "step_axis_xy", "getInputVoltage", "modifyZone", "getField", "getStats", "getLastPath", "create_field", "restart_gnss_publisher_service", "wait_working_state_refresh", "penetrometry_new_params"]
