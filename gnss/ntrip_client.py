    ...
    def read(self):
        ...
        if not self.found_header:
            ...
            try:
                ...
                casterResponse = ''
            if sys.version_info.major >= 3:
                casterResponse = str(casterResponse, self.caster_response_decode)
        ...
        while True:
            ...
            if self.rtcm3.read(data):
                ...
                if time.time()-self.lastSend>=4 and self.send_location_to_ntrip:
    ...
    def readAndSendLoop(self):
        ...
        try:
            while True:
                ...
                if not in_filters_id and len(self.rtk_id_send) > 0:
                    continue
                ...
                if has_filters and len(self.rtk_id_send) > 0:
                    list_RTCM_ID_sent = []
