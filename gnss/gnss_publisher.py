...
class GNSSPublisher:
    ...
    def parse_gga(line, receiving_ts):
        ...
        print(f"[DEBUG] Parsed latitude: {latitude:.20f}, fields[2]: {fields[2]}, fields[3]: {fields[3]}", flush=True)
        longitude = GNSSPublisher.nmea_coordinate_to_decimal(fields[4], fields[5])
        print(f"[DEBUG] Parsed longitude: {longitude:.20f}, fields[4]: {fields[4]}, fields[5]: {fields[5]}", flush=True)
