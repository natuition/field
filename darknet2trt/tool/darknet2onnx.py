...
def transform_to_onnx(cfgfile, weightfile, batch_size=1, onnx_prefix_file_name="yolov4_-1_3", onnx_file_name=None):
    ...
    if dynamic:
        ...
        if not onnx_file_name:
            onnx_file_name = "{}_{}_{}.onnx".format(onnx_prefix_file_name, model.height, model.width)
...
if __name__ == '__main__':
    ...
    transform_to_onnx(args.config, args.weightfile, args.batch_size, onnx_file_name=args.onnx_file_path)
