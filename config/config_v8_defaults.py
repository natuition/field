...
# ======================================================================================================================
KP_PURSUIT = 0.2  # 0.4 wheels turning degrees multiplier
KI_PURSUIT = 0.0092   #0.03 80mm dev
KP_CRUISE = 100      #  0.015mou_nickel 0.02osc wheels turning degrees multiplier
KI_CRUISE = 0.03*0.4*0      #      0.012*0.015*0.000001*0.6 correct  0.595 trop mou
...
CRUISE_EXIT = 1000  # max allowed robot's deviation from corridor im mm-s (threshold)
PURSUIT_ANGLE_LIMIT = 45
...
# ======================================================================================================================
PRECISE_CONFIDENCE_THRESHOLD = 0.999    # Confidence threshold
