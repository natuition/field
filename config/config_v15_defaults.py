...
CAMERA_POSITIONS = [(150, 0), (150, 110), (300, 110), (300, 0)] # smoothie global coordinates to take photos from for forming plants list. Format is (x, y)
PDZ_DISTANCES = {"top": 400, "bot": 650, "left": 800, "right": 700} # precice detection zone sizes. At each camera position scan only plants inside this zone is added to extraction list
