...
VESC_CHECK_FREQ = 0.001  # freq of checking need to stop (was 0.01)
STEP_FORWARD_TIME = 2  # step after extraction loops are done
...
EXTRACTION_Z = 45  # value that passed to smoothie when doing plant extraction
Z_F_EXTRACTION_UP = 1500
Z_F_EXTRACTION_DOWN = 1600
...
PERIPHERY_CONFIG_FILE = "yolo/Y0012.cfg"
PERIPHERY_WEIGHTS_FILE = "yolo/Y0012.weights"
...
PRECISE_INPUT_SIZE = (832, 832)  # works only in opencv wrapper
PRECISE_CONFIG_FILE = "yolo/Y0012.cfg"
PRECISE_WEIGHTS_FILE = "yolo/Y0012.weights"
PRECISE_CLASSES_FILE = "yolo/tinyperif.names"
