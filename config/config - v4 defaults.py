...
ALLOW_PRECISE_RESCAN = False  # allow plant center specifying by precise NN if box was detected by periphery NN (happens when plant initially is in undistorted zone and plants list generated by periphery NN)
