...
# DR_U3_50Y2C_C3_S camera
# CAMERA_W = 2592
# CAMERA_H = 1944
# APPLY_IMAGE_CROPPING = True
# CROP_W_FROM = (CAMERA_W-1920)/2
# CROP_W_TO = 1920+CROP_W_FROM
# CROP_H_FROM = (CAMERA_H-1080)/2
# CROP_H_TO = 1080+CROP_H_FROM
# GAIN_RANGE_FROM = 0
# GAIN_RANGE_TO = 0
# EXPOSURE_TIME_RANGE_FROM = 10000
# EXPOSURE_TIME_RANGE_TO = 10000
