...
KP = {-2500:0.2, -10000:0.2*0.55}
KI = {-2500:0.0092, -10000:0.0092*0.91}
...
FAR_TARGET_THRESHOLD = {-2500:25000, -10000:25000} # the output of the KP KI is boost if the target is far than this threshold
FAR_TARGET_GAIN = {-2500:1.15, -10000:1.15}   # the output of the KP KI is boost by this muliplier if the target is far than the threshold
CLOSE_TARGET_THRESHOLD = {-2500:5000, -10000:5000} # the output of the KP KI is managed if the target is less than this threshold
SMALL_RAW_ANGLE_SQUARE_THRESHOLD = {-2500:100, -10000:100}  # the output of the KP KI is calm by a muliplier if the raw angle is less than the threshold
SMALL_RAW_ANGLE_SQUARE_GAIN = {-2500:0.9, -10000:1}    # the output of the KP KI is calm by this muliplier if the raw angle is less than the threshold
BIG_RAW_ANGLE_SQUARE_THRESHOLD = {-2500:625, -10000:625}  # the output of the KP KI is boost by a muliplier if the raw angle is more than the threshold
BIG_RAW_ANGLE_SQUARE_GAIN = {-2500:1.35, -10000:1.35}   # the output of the KP KI is boost by this muliplier if the raw angle is more than the threshold
...
PRECISE_CONFIG_FILE = "yolo/Y0017F_832.cfg"
PRECISE_WEIGHTS_FILE = "yolo/Y0017F_832.weights"
